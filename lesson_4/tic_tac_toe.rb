...
def display_board(brd, score)
  ...
  puts "You have won #{score[:player]} games and\
 the Computer has won #{score[:computer]}"
  puts ""
  puts "     |     |"
...
def find_odd_open_squares(brd, marker)
  choices = []
  brd.each_with_index do |index, _|
...
def take_turns(current_player, board, score)
  loop do
...
loop do
  ...
  loop do
    ...
    take_turns(who_starts, board, score)
